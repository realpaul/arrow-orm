...
Instance.prototype.validateCoersiveTypes = function(field, name, value) {
...
var internal = ['_dirty','_deleted','_metadata','_dirtyfields','_events','_values','_model'];
Instance.prototype.set = function set() {
	...
	if (typeof(arguments[0])==='object') {
		...
		// do serialization
		if (skipNotFound) {
			value = this._model.serialize(name,value);
		}
		else {
			value = this._model.deserialize(name,value);
		}
