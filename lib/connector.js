 ...
 */
Connector.prototype.createMultiple = function createMultiple(Model, values, callback) {
 ...
 * @param {Function} callback Callback passed an Error object (or null if successful).
 */
Connector.prototype.deleteMultiple = function deleteMultiple(Model, ids, callback) {
 ...
 * @param {Function} callback Callback passed an Error object (or null if successful).
 */
Connector.prototype.findMultiple = function findMultiple(Model, ids, callback) {
