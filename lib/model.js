...
Model.prototype.create = function create(values, callback) {
	...
	if (Array.isArray(values)) {
		return this.getConnector().createMultiple(this, values.map(function(v){
...
Model.prototype.remove = function remove(instance, callback) {
	...
	if (_.isArray(instance)){
		return this.getConnector().deleteMultiple(this, instance, callback);
	}
...
Model.prototype.findOne = function findOne(id, callback) {
	try {
		this.getConnector()[_.isArray(id) ? 'findMultiple' : 'findOne'](this, id, callback);
	} catch (E) {
		return callback(E);
	}
};
