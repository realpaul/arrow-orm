...
Model.prototype.deleteAPI = function deleteAPI() {
	return {
		...
		parameters: {
			id: { description: 'The ' + this.singular + ' ID' }
		},
...
Model.prototype.deleteAllAPI = function deleteAllAPI() {
	return {
		method: 'DELETE',
		description: this.description || 'Deletes all ' + this.singular,
		action: function deleteAction(req, resp, next) {
...
Model.prototype.findAndModifyAPI = function findAndModifyAPI() {
	...
	var parameters = {
		...
		page: { type: 'query', optional: true, default: 1, description: 'Request page number starting from 1.' },
		per_page: { type: 'query', optional: true, default: 10, description: 'Number of results per page.' }
	};
	Object.keys(model.fields).forEach(function (k) {
		var field = model.fields[k];
		parameters[k] = {
	...
	return {
		...
		action: function queryAction(req, resp, next) {
			// TODO: Check that req.query etc are passing in correctly.
...
Model.prototype.upsertAPI = function upsertAPI() {
	...
	result.description = this.description || 'Upsert a ' + this.singular;
