...
function Model(name, definition, skipValidation){
	...
	// pull our any method definitions
	this.methods = definition && _.omit(definition,'name','fields','connector','metadata');
 ...
 */
Model.prototype.getConnector = function(dontRaiseException) {
...
Model.prototype.remove = function remove(instance, callback) {
	...
	if (typeof(instance)!=='object') {
		return this.getConnector().findOne(instance, function findOneCallback(err,instance){
			if (err) { return callback(err); }
